...
> **Latest release:** <!-- managed:version -->v1.0.16<!-- /managed:version --> — [download the VSIX from Releases](https://github.com/nachum-shmilovitz-66/claude-code-visualstudio/releases/latest)

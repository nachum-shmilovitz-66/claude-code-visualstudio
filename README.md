...
> **Latest release:** <!-- managed:version -->v0.2.33<!-- /managed:version --> — [download the VSIX from Releases](https://github.com/nachum-shmilovitz-66/vs-claude-code/releases/latest)
